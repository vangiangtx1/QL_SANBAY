...
namespace QL_SANBAY
{
    public partial class frmDangNhap : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nhập đầy đủ thông tin đăng nhập", "", MessageBoxButtons.OK);
                return;
            }
            Program.mlogin = txtTenDN.Text; Program.password = txtMK.Text;
            if (Program.KetNoi() == 0)
            {
                MessageBox.Show("Thông tin đăng nhập chưa chính xác.", "", MessageBoxButtons.OK);
                return;
            } 
            ...
            MessageBox.Show("Đăng nhập thành công với đối tượng " + Program.Nhom, "", MessageBoxButtons.OK);
