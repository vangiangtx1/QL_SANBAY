...
namespace QL_SANBAY
{
    public partial class frmNhanVienBaoTri : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnHuy_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có thực sự muốn xóa nhân viên khỏi đợt bảo trì này ?",
                "Xác nhận", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                ...
                MessageBox.Show("Xóa thành công nhân viên khỏi đợt bảo trì ! ", "", MessageBoxButtons.OK);
            }
        }
