...
namespace QL_SANBAY
{
    public partial class frmBaoTri : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnXoa_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                MessageBox.Show("Không thể xóa vì đang có nhân viên bảo trì! ", "", MessageBoxButtons.OK);
                return;
            }
            if (MessageBox.Show("Bạn có thực sự muốn xóa đợt bảo trì này ?",
                "Xác nhận", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                ...
                MessageBox.Show("Xóa thành công đợt bảo trì ! ", "", MessageBoxButtons.OK);
            }
        }
